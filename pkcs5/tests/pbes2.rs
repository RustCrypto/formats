...
const PBES2_PBKDF2_SHA256_AES256CBC_ALG_ID_NO_NULL_PARAM: &[u8] = &hex!(
    "305506092a864886f70d01050d3048302706092a864886f70d01050c301a0408
     79d982e70df91a8802020800300a06082a864886f70d0209301d060960864801
     650304012a0410b2d02d78b2efd9dff694cf8e0af40925"
);
...
fn decode_pbes2_pbkdf2_sha256_aes256cbc_without_null_parameter() {
    let scheme = pkcs5::EncryptionScheme::try_from(PBES2_PBKDF2_SHA256_AES256CBC_ALG_ID_NO_NULL_PARAM).unwrap();
    let params = scheme.pbes2().unwrap();
