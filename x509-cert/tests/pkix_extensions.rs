...
use x509_cert::{Certificate, Version, serial_number::SerialNumber};
                        ...
                        1 => match dpn {
                            DistributionPointName::FullName(gns) => {
                                ...
                                match gn {
                                    GeneralName::UniformResourceIdentifier(uri) => {
                                        assert_eq!(
                                            "ldap://ldap-pte.identrust.com.test/cn%3DIGC%20Root%20CA1%2Co%3DIdenTrust%2Cc%3DUS%3FcertificateRevocationList%3Bbinary",
                                            uri.to_string()
                                        );
                                    }
                                    _ => {
...
fn decode_idp_negative() {
    ...
    let reason_flags = ReasonFlags::from_der(&hex!("FFFFFFFFFF03079F80"));
    let err = reason_flags.err().unwrap();
    ...
    let idp = IssuingDistributionPoint::from_der(&hex!(
        ""
    ));
    let err = idp.err().unwrap();
    ...
    let idp = IssuingDistributionPoint::from_der(&hex!(
        ""
    ));
    let err = idp.err().unwrap();
    assert_eq!(
        ErrorKind::Length {
